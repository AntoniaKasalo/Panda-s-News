...
$sql = "SELECT * FROM news WHERE category='house_pets' ORDER BY id DESC";
...
<body>
    <header id="headera" class="bg-dark text-white">
        <div class="header-content">
            <h1 class="mb-3">House Pets News</h1>
            <p class="lead">Latest news about house pets!</p>
        </div>
    </header>
