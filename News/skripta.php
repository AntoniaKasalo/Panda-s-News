...
if ($article_id) {
...
} elseif ($_FILES["pphoto"]["tmp_name"] && move_uploaded_file($_FILES["pphoto"]["tmp_name"], $target_file)) {
    ...
    echo "<script>alert('Failed to upload the image.'); window.location.href='unos.php';</script>";
}
